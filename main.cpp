...
//the doctor class
class doctor{//the info about doctors
    public:
...
//the addDoc function
void addDoc(){//for adding the new doctor.
        doctor d;
        ...
        fstream fileObj;//adding the new doc to the txt file.
...
void editDoc(doctor &docobj){//editing the doc info
    string x;
    ...
    if(count==0){
        ...
        exit(0);
                            ...
                            //datatransfer begins
    fstream file("doctor.txt");//adding the edited info to the doctor file.
...
void displayDoc()
{
int x;//accessing the file of a particular doctor
...
void deleteDoc(){    string x;//deleting the profile of a doc.
...
void dispDatabase(){//for displaying the file
    fstream fileObj("doctor.txt");
    fileObj.seekg(0);
...
void numberofDocs(){//total number of doctors
    fstream fileObj("doctor.txt");
    fileObj.seekg(0);
    int age,exp,count=0;
    string ID,fname,lname,ci,qua,spe;
...
//the patient class
class patient{//for the patients
    public:
...
//the addPat function
void addPat(){//adding the new patient in the database
...
void editPat(patient &pat){//editing the info of one particular patient
    int x;
...
void deletePat()
{//for removing the patient from the database
int x;
...
void dispPatDatabase(){//displaying the whole database
